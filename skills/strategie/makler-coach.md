...
- `skills/strategie/verhandlungs-assistent.md` -- Preisverhandlung nach erfolgreicher Makler-Kontaktaufnahme
- `skills/strategie/akquise-netzwerk.md` -- Makler als einer von 12 Akquise-Kanaelen (Gesamtstrategie)
- `skills/ankauf/deal-screener.md` -- Schnellbewertung der vom Makler gelieferten Deals
- `skills/ankauf/bierdeckel-kalkulation.md` -- Schnelle Kalkulation fuer schnelle Rueckmeldung an den Makler
- `skills/strategie/bankgespraech-coach.md` -- Finanzierungszusage als Makler-Argument vorbereiten

...
- `skills/ankauf/deal-screener.md` -- Objektbewertung VOR der Verhandlung (ist das Objekt ueberhaupt verhandlungswuerdig?)
- `skills/ankauf/bierdeckel-kalkulation.md` -- Schnelle Renditeberechnung fuer preisbasierte Argumente
- `skills/strategie/makler-coach.md` -- Maklerbeziehung als Verhandlungsvorteil nutzen
- `skills/strategie/bankgespraech-coach.md` -- Finanzierungszusage als Verhandlungsargument vorbereiten

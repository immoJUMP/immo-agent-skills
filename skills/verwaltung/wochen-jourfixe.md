...
- `skills/verwaltung/mahn-assistent.md` -- Detail-Skill fuer Mahnwesen bei Mietrueckstaenden
- `skills/verwaltung/nebenkosten-pruefer.md` -- Detail-Skill fuer Nebenkostenpruefung
- `skills/vermietung/mieterhoehung.md` -- Mieterhoehungspotenzial fuer Vermietungs-Kategorie

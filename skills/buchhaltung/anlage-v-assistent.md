...
- `skills/buchhaltung/beleg-sortierer.md` -- Vorheriger Schritt: Belege klassifizieren
- `skills/buchhaltung/datev-vorbereitung.md` -- Vorheriger Schritt: Buchungssaetze erstellen
- `skills/vermietung/mieterhoehung.md` -- Mietspiegel und ortsuebliche Miete

...
- `skills/vermietung/mieterhoehung.md` -- Mietpreisbremse-Pruefung bei Neuvermietung
- `skills/vermietung/vermieterbescheinigung.md` -- Nach erfolgreicher Vermietung: Bescheinigung erstellen
- `skills/dokumente/expose-parser.md` -- Expose-Daten aus vorhandenen Unterlagen extrahieren

...
- `skills/vermietung/inserat-generator.md` -- Inserat erstellen fuer die Neuvermietung
- `skills/vermietung/mieterhoehung.md` -- Mieterhoehung nach Neuvermietung oder im Bestand
- `skills/vermietung/vermieterbescheinigung.md` -- Vermieterbescheinigung nach §19 BMG
- `skills/dokumente/mietvertrag.md` -- Mietvertragserstellung (falls vorhanden)
- `skills/objektpruefung/risiko-scanner.md` -- Risikobewertung des Objekts

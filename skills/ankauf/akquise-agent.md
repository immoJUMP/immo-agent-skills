...
- `skills/ankauf/deal-screener.md` -- Schnellbewertung einzelner Objekte (komplementaer: Screener fuer Einzelobjekte, Akquise-Agent fuer Massensuche)
- `skills/ankauf/bierdeckel-kalkulation.md` -- Schnelle Rendite- und Cashflow-Kalkulation
- `skills/ankauf/marktanalyse.md` -- Vertiefte Standort- und Marktanalyse

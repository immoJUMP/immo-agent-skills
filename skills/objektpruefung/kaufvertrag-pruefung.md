...
- `skills/ankauf/deal-screener.md` -- Schnellbewertung vor Kaufvertragsphase
- `skills/objektpruefung/risiko-scanner.md` -- Detaillierte Risikobewertung
- `skills/objektpruefung/unterlagen-analyst.md` -- Analyse aller Objektunterlagen
- `skills/finanzierung/bankenkonzept.md` -- Finanzierungsstruktur und Bankenpitch
- `skills/finanzierung/selbstauskunft.md` -- Bonitaetsunterlagen fuer die Bank

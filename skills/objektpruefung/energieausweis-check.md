...
- `skills/objektpruefung/unterlagen-analyst.md` -- Gesamtanalyse der Objektunterlagen
- `skills/objektpruefung/risiko-scanner.md` -- Kategorie 4: Energetische Risiken (Zusammenspiel)
- `skills/objektpruefung/besichtigung-prep.md` -- Heizungs- und Daemmungs-Check bei Besichtigung
- `skills/vermietung/mieterhoehung.md` -- Modernisierungsumlage in Mieterhoehungsstrategie integrieren

...
- `skills/objektpruefung/unterlagen-analyst.md` -- Gesamtanalyse inkl. Mietlisten-Abgleich
- `skills/objektpruefung/risiko-scanner.md` -- Kategorien 2 (Mietstruktur) und 6 (Mieterrisiken)
- `skills/vermietung/mieterhoehung.md` -- Mieterhoehungsstrategie und Umsetzung
- `skills/dokumente/mietlisten-parser.md` -- PDF-Mietlisten in strukturierte Daten konvertieren

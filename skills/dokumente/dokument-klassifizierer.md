...
- `skills/buchhaltung/beleg-sortierer.md` -- Weiterverarbeitung von Rechnungen und Belegen
- `skills/dokumente/mietlisten-parser.md` -- Spezial-Skill fuer Mietlisten
- `skills/dokumente/expose-parser.md` -- Spezial-Skill fuer Exposes
- `skills/objektpruefung/unterlagen-analyst.md` -- Analyse von Ankaufsunterlagen

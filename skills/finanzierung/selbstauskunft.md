...
- `skills/finanzierung/bankenkonzept.md` -- Finanzierungsstruktur und -vergleich
- `skills/finanzierung/bankenpitch.md` -- Praesentation fuer das Bankgespraech
- `skills/finanzierung/cashflow-modell.md` -- Detailliertes Cashflow-Modell fuer das Objekt
- `skills/objektpruefung/kaufvertrag-pruefung.md` -- Kaufvertragspruefung nach Finanzierungszusage
- `skills/ankauf/bierdeckel-kalkulation.md` -- Schnelle Rendite-Kalkulation fuer die Erstbewertung

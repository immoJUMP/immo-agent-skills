...
- `skills/finanzierung/bankenkonzept.md` -- Finanzierungskonzept, das die Cashflow-Projektion einbettet
- `skills/finanzierung/bankenpitch.md` -- Praesentationsdokument mit integrierter Cashflow-Darstellung

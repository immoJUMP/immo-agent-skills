...
Rueckmeldungen aus der Praxis sind ausdruecklich willkommen -- siehe
[CONTRIBUTING.md](CONTRIBUTING.md).

- Fehler melden (veraltete Gesetze, falsche Berechnungen)
- Regionale Abweichungen berichten (Mietspiegel, Sanierungskosten)
- Neue Skills anregen
...
**immoJUMP Source Available License 1.0** -- siehe [LICENSE](LICENSE).

Kurzfassung: Du darfst die Skills in deinem eigenen Unternehmen einsetzen, auch
gewerblich und fuer Dienstleistungen an deine Kunden. Die damit erzeugten
Ergebnisse (Exposes, Analysen, Kalkulationen) gehoeren dir uneingeschraenkt.

Nicht erlaubt sind Weitergabe an Dritte, Weiterverkauf sowie der Einsatz in
Schulungen, Seminaren oder Produkten, die Dritten angeboten werden.

Fuer eine weitergehende Lizenz: skills@immojump.de
